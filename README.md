# Código de Comunidad PHP de Venezuela
...
convenidos por todos los miembros de **PHP de Venezuela** en cualesquiera de los
espacios de participación físicos o digitales que tengamos a bien convenir en el
...
* Cualquier toma de decisiones debe estar precedida por:
    * Una convocatoria con una antelación mínima de un día y medio (1 1/2 día) 
      por cualquiera de los canales de comunicación y/o contacto (a saber:
      Telegram, IRC, Foro).
...
* Abstenerte de adoptar una conducta y un lenguaje degradantes,
  discriminatorios, soez, abusivos y/o acosador.
...
* Aquella persona que se encuentre en estado de suspensión temporal, se verá
  imposibilitada a representar a la **Comunidad PHP de Venezuela** en ninguna 
  reunión, grupo o comitiva.
...
la condición humana. Conserve la netiqueta.

Estas son las políticas para mantener los estándares de conducta en nuestra
comunidad en los canales de comunicación (a saber: Telegram, IRC y Foro).
...
* Aquella persona que se encuentre en estado de suspensión temporal, se verá
  imposibilitada a representar a la **Comunidad PHP de Venezuela** en 
  ninguna reunión, grupo o comitiva.
